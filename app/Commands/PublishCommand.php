...
namespace Bpocallaghan\Locations\Commands;
...
class PublishCommand extends Command
{
    ...
    private function copyModels()
    {
        ...
        // copy files
        $search = "namespace Bpocallaghan\Locations\Models;";
    ...
    {
        // ADMIN
        $source = $this->basePath . "resources\\views\admin\\cities";
        $destination = resource_path('views\admin\locations\\cities');
        $this->copyFilesFromSource($source, $destination);

        $source = $this->basePath . "resources\\views\admin\\countries";
        $destination = resource_path('views\admin\locations\\countries');
        $this->copyFilesFromSource($source, $destination);

        $source = $this->basePath . "resources\\views\admin\\provinces";
        $destination = resource_path('views\admin\locations\provinces');
        $this->copyFilesFromSource($source, $destination);

        $source = $this->basePath . "resources\\views\admin\\suburbs";
        $destination = resource_path('views\admin\locations\suburbs');
        $this->copyFilesFromSource($source, $destination);
    }
    ...
    private function copyControllers()
    {
        ...
        $destination = app_path('Http\Controllers\Admin\Locations');

        // copy files
        $search = ["locations::", "Bpocallaghan\Locations\Models", "namespace Bpocallaghan\Locations\Controllers\Admin;"];
        $replace = ["locations.", "App\Models", "namespace App\Http\Controllers\Admin\Locations;"];
        $this->copyFilesFromSource($source, $destination, $search, $replace);
    }
